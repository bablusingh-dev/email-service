...
export const projects = pgTable(
    'projects',
    {
        ...
        provider: varchar('provider', { length: 50 }).notNull().default('resend'), // resend, sendgrid, ses, brevo
        ...
        environment: varchar('environment', { length: 20 }).notNull().default('production'), // dev, staging, production
